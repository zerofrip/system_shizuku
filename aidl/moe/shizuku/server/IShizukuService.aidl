...
// Stubs for types used in IShizukuService
...
interface IShizukuService {
    ...
    int addUserService(in IBinder conn, in Bundle args) = 11;

    int removeUserService(in IBinder conn, in Bundle args) = 12;
    ...
    void attachApplication(in IBinder application, in Bundle args) = 17;
